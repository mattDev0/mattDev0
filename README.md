...
### 🚀 What I'm working on:
* **[DevOps Control Center](https://github.com/mattDev0/devops-control-center)** - A custom, end-to-end DevOps orchestration platform featuring a live Rust-backed WebSockets PTY terminal, Kubernetes deployment management, zero-downtime rolling updates, and an embedded Prometheus/Grafana observability stack.
* **[Polyglot Portfolio Architecture](https://github.com/mattDev0/portfolio-monorepo)** - A high-performance, microservice-backed personal portfolio leveraging React, Java Spring Boot, and Rust. Fully orchestrated with K3s and continuously deployed via automated GitHub Actions pipelines.

### 🔭 Current Focus:
- Architecting robust, secure, and scalable microservices.
- Designing zero-downtime CI/CD pipelines.
